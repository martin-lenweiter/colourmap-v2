      ...
      <div className="space-y-2">
        <div className="flex items-center justify-center gap-2">
          {INNER_TRACKERS.map((t, idx) => {
            ...
            const hasContent = trackerValues[t.id]?.trim();
            const size = isOpen ? 48 : 38;
            return (
              <button
                key={t.id}
                type="button"
                onClick={() => setOpenTracker(isOpen ? '' : t.id)}
                ...
                style={{
                  ...
                  background: t.color,
                  opacity: isOpen ? 1 : hasContent ? 0.8 : 0.6,
                  border: 'none',
                  padding: 0,
                }}
              >
        ...
        {/* Open tracker questions */}
        {openTracker &&
          (() => {
            const tracker = INNER_TRACKERS.find((t) => t.id === openTracker);
                  ...
                  {canUnlockNext && (
                    <div className="flex justify-center py-2">
                      <button
                        ...
                        className="flex h-3.5 w-3.5 rotate-45 items-center justify-center transition-all hover:scale-125"
                        style={{
