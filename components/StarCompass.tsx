...
function getStarSlices(theme: (typeof STAR_THEMES)[0]) {
  // Order: left, top, right, bottom — spells S.T.A.R, matches compass spatial reading
  return [
    {
...
export default function StarCompass({ initialSlice }: { initialSlice?: string | null } = {}) {
  ...
  return (
    ...
    >
      ...
      {/* STAR blobs — transform into rainbow slider when centre star is clicked */}
      {showSlider && activeQ ? (
        (() => {
