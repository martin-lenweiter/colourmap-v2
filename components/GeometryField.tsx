...
const MODE_SLIDERS: Partial<Record<Mode, SliderDef[]>> = {
  ...
  vitral: [
    ...
    { key: 'glow', label: 'Glow', min: 0, max: 10, step: 0.5 },
    { key: 'breathSpeed', label: 'Drift', min: 0.2, max: 3, step: 0.1 },
    { key: 'intensity', label: 'Colour', min: 0, max: 10, step: 0.5 },
    { key: 'luminous', label: 'Luminous', min: 0, max: 10, step: 0.5 },
  ],
  fibonacci: [
    ...
    { key: 'glow', label: 'Glow', min: 0, max: 10, step: 0.5 },
    { key: 'breathSpeed', label: 'Bloom', min: 0.2, max: 3, step: 0.1 },
    { key: 'intensity', label: 'Colour', min: 0, max: 10, step: 0.5 },
    { key: 'luminous', label: 'Luminous', min: 0, max: 10, step: 0.5 },
    { key: 'stars', label: 'Stars', min: 0, max: 10, step: 1 },
  ],
  clifford: [
    ...
    { key: 'glow', label: 'Glow', min: 0, max: 10, step: 0.5 },
    { key: 'breathSpeed', label: 'Morph', min: 0.1, max: 3, step: 0.1 },
    { key: 'intensity', label: 'Colour', min: 0, max: 10, step: 0.5 },
    { key: 'luminous', label: 'Luminous', min: 0, max: 10, step: 0.5 },
    { key: 'stars', label: 'Stars', min: 0, max: 10, step: 1 },
  ],
  hypercube: [
    ...
    { key: 'glow', label: 'Glow', min: 0, max: 10, step: 0.5 },
    { key: 'breathSpeed', label: 'Rotate', min: 0.1, max: 3, step: 0.1 },
    { key: 'intensity', label: 'Colour', min: 0, max: 10, step: 0.5 },
    { key: 'luminous', label: 'Luminous', min: 0, max: 10, step: 0.5 },
    { key: 'stars', label: 'Stars', min: 0, max: 10, step: 1 },
  ],
  ...
  lorenz: [
    ...
    { key: 'glow', label: 'Glow', min: 0, max: 10, step: 0.5 },
    { key: 'breathSpeed', label: 'Spin', min: 0.1, max: 3, step: 0.1 },
    { key: 'intensity', label: 'Colour', min: 0, max: 10, step: 0.5 },
    { key: 'luminous', label: 'Luminous', min: 0, max: 10, step: 0.5 },
    { key: 'stars', label: 'Stars', min: 0, max: 10, step: 1 },
  ],
